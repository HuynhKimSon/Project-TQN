...
public class SysMenuController extends BaseController {
	 ...
	 * Delete menu
	 */
	@Log(title = LogTitleConstant.SYS_MENU, businessType = BusinessType.DELETE)
	 ...
	 * Added save menu
	 */
	@Log(title = LogTitleConstant.SYS_MENU, businessType = BusinessType.INSERT)
	 ...
	 * Modify save menu
	 */
	@Log(title = LogTitleConstant.SYS_MENU, businessType = BusinessType.UPDATE)
