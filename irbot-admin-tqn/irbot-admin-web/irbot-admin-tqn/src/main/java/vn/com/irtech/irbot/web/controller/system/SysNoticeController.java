...
//    @RequiresPermissions("system:notice:add")
	@Log(title = LogTitleConstant.SYS_NOTICE, businessType = BusinessType.INSERT)
	@PostMapping("/add")
	@ResponseBody
...
//    @RequiresPermissions("system:notice:edit")
	@Log(title = LogTitleConstant.SYS_NOTICE, businessType = BusinessType.UPDATE)
	@PostMapping("/edit")
	@ResponseBody
...
//    @RequiresPermissions("system:notice:remove")
	@Log(title = LogTitleConstant.SYS_NOTICE, businessType = BusinessType.DELETE)
	@PostMapping("/remove")
	@ResponseBody
