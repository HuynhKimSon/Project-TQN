...
public class SysOperlogController extends BaseController {
	...
	@Log(title = LogTitleConstant.SYS_OPERATION_LOG, businessType = BusinessType.EXPORT)
	...
	@Log(title = LogTitleConstant.SYS_OPERATION_LOG, businessType = BusinessType.CLEAN)
	@RequiresPermissions("monitor:operlog:remove")
	@PostMapping("/clean")
	@ResponseBody
