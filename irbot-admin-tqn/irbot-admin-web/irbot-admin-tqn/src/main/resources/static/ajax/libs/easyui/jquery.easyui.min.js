...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        ...
        }, beforePageText: "Page", afterPageText: "of {pages}", displayMsg: "Hiển thị {from} đến {to} -- {total} dòng", nav: {
            first: {
...
(function ($) {
    ...
    function _2a2(_2a3) {
        ...
        _2a4.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _2a4.options.draggable == false, onBeforeDrag: function (e) {
                if (_2a4.mask) {
        ...
        _2a4.window.resizable({
            disabled: _2a4.options.resizable == false, onStartResize: function (e) {
                _2a5(e);
            }, onResize: function (e) {
                _2a6(e);
                return false;
...
(function ($) {
    ...
    function _2d0(_2d1) {
        ...
        dlg.dialog($.extend({}, _2d1, {
            noheader: (_2d1.title ? false : true), onClose: function () {
                _2cc();
                if (_2d1.onClose) {
...
(function ($) {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, halign: "top", onSelect: function (_32b, _32c) {
...
(function ($) {
    ...
    function _365(_366, _367, pp) {
        ...
        pp.panel($.extend({}, _367, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_367.icon ? _367.icon : undefined), onLoad: function () {
                if (_367.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 32, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3b2) {
...
(function ($) {
    ...
    function _3d1(_3d2, _3d3, el) {
        ...
        _3d9.resizable($.extend({}, {
            handles: (_3d8[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _3c1 = true;
    ...
    function _3ee(_3ef, _3f0, _3f1) {
        ...
        function _3f5(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", titleDirection: _3f3.titleDirection, iconCls: (_3f3.hideCollapsedContent ? null : _3f3.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _3f3.region, collapsedSize: _3f3.collapsedSize, noheader: (!isns && _3f3.hideExpandTool), tools: ((isns && _3f3.hideExpandTool) ? null : [{
    ...
    $.fn.layout.defaults = {
        fit: false, onExpand: function (_422) {
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapsedSize: 32, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_427) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 150, itemHeight: 32, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _442, mouseleave: _445, mouseover: _449, mouseout: _44c, click: _44e }, position: function (_47f, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    function _489(_48a, _48b, data) {
        ...
        $(_48b).tooltip({
            content: $("<div></div>"), position: opts.floatMenuPosition, valign: "top", data: data, onUpdate: function (_48c) {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 30, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_4f4) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiobutton.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_51a) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkbox.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_540) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function _58a(_58b, _58c) {
        ...
        _592.css({ width: opts.iconWidth + "px", height: "28px" });
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: {
            focus: _5e2, blur: _5e6, keydown: function (e) {
...
(function ($) {
    ...
    function load(_652, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _653, dataType: "json", success: function (data) {
                    _654(data);
                }, error: function () {
...
(function ($) {
    function _6be(_6bf) {
        ...
        $(_6bf).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _6c1, doSize: false, onResize: function (_6c3, _6c4) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    function _74c(_74d) {
        ...
        _74f.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_750, _751) {
        ...
        if (opts.pagination) {
            ...
            _755.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_756, _757) {
    ...
    function _764(_765) {
        ...
        _76a.each(function () {
            $(this).resizable({
                handles: _76b, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _766.resizing = true;
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", resizeEdge: 5, autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 31, headerEvents: { mouseover: _76e(true), mouseout: _76e(false), click: _772, dblclick: _777, contextmenu: _77a }, rowEvents: { mouseover: _77c(true), mouseout: _77c(false), click: _783, dblclick: _78d, contextmenu: _791 }, rowStyler: function (_92d, _92e) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _92f, dataType: "json", success: function (data) {
                    _930(data);
                }, error: function () {
...
(function ($) {
    ...
    function _969(_96a) {
        ...
        $(_96a).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_96c, row) {
...
(function ($) {
    function _9cf(_9d0) {
        ...
        if (opts.pagination) {
            ...
            _9dc.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_9dd, _9de) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _a75, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _9ea(true), mouseout: _9ea(false), click: _9ec }), loader: function (_ab3, _ab4, _ab5) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _ab3, dataType: "json", success: function (data) {
                    _ab4(data);
                }, error: function () {
...
(function ($) {
    function _ac1(_ac2) {
        ...
        $(_ac2).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_ac3, row, _ac4) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _ac5, textFormatter: function (_ae1, row) {
            return _ae1;
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _af6, keydown: _afa, paste: _afa, drop: _afa, blur: _afd }, panelEvents: {
            mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }
        }, panelWidth: null, panelHeight: null, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: 300, panelAlign: "left", panelValign: "auto", reversed: false, multiple: false, multivalue: true, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
            up: function (e) {
            }, down: function (e) {
            }, left: function (e) {
            }, right: function (e) {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_b87) {
            return _b87;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _b81, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            mouseover: _b65, mouseout: _b66, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _b67, scroll: _b6a
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _b8b, dataType: "json", success: function (data) {
                    _b8c(data);
                }, error: function () {
...
(function ($) {
    function _c36(_c37) {
        ...
        $(_c37).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_c39, _c3a) {
                _c3b();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_c68) {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_d33) {
            return _d33;
        }, converter: {
