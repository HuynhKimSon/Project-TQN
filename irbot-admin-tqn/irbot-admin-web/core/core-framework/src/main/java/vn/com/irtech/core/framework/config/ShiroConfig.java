...
//        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("irtech");
...
//        UserRealm userRealm = SpringUtils.getBean(UserRealm.class); //new UserRealm();
