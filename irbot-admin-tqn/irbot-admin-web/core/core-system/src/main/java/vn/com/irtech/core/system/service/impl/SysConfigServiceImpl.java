...
import vn.com.irtech.core.common.utils.CacheUtils;
import vn.com.irtech.core.common.utils.StringUtils;
import vn.com.irtech.core.system.domain.SysConfig;
import vn.com.irtech.core.system.mapper.SysConfigMapper;
	...
	public void deleteConfigByIds(String ids)
    {
		...
		for (Long configId : configIds)
        {
			...
			if (StringUtils.equals(UserConstants.YES, config.getConfigType())) {
				throw new BusinessException(String.format("Không thể xóa tham số tích hợp【%1$s】 ", config.getConfigKey()));
			}
