...
public class SysDept extends BaseEntity {
	...
	@Size(min = 0, max = 30, message = "部门名称长度不能超过30 ký tự")
	...
	@Size(min = 0, max = 11, message = "联系电话长度不能超过11 ký tự")
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("deptId", getDeptId())
				.append("parentId", getParentId()).append("deptCode", getDeptCode()).append("ancestors", getAncestors())
				.append("deptName", getDeptName()).append("orderNum", getOrderNum()).append("leader", getLeader())
				.append("phone", getPhone()).append("email", getEmail()).append("status", getStatus())
